# Generated by Django 3.1.5 on 2021-01-13 19:14
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('publicity', models.CharField(choices=[('p', 'public'), ('pr', 'private')], default='pr', help_text='Do you want this goal to be available to the public?', max_length=7)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('goals', models.ManyToManyField(to='goal.Goal')),
            ],
        ),
        migrations.AddField(
            model_name='user',
            name='rated',
            field=models.ManyToManyField(blank=True, to='goal.Goal'),
        ),
        migrations.AddField(
            model_name='user',
